...
const LinkedinOptions = [
  {
    label: 'Share Post on LinkedIn',
    value: 'linkedin_share'
  },
  {
    ...
    <Box className="bg-fuchsia-700 bg-opacity-10 hover:bg-opacity-20 p-3">
      <Box display="flex" alignItems="center" justifyContent="space-between">
        <div className="flex items-center w-full">
          <img className="w-10" src={linkedin_icon} />
          <TextField
            select
            label="Step"
            SelectProps={{
        ...
        <>
          ...
          <Box display="flex" width="100%" className="mt-3">
            ...
            <input
              ...
              type="text"
              placeholder={
                step.action === 'linkedin_share'
                  ? 'https://www.linkedin.com/feed/update/urn:li:activity:6448201884325933056'
